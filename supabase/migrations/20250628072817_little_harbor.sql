...
BEGIN
    ...
    DROP POLICY IF EXISTS "Agency staff can view agency notifications" ON public.notifications;
...
DROP TRIGGER IF EXISTS document_upload_notification_trigger ON public.documents;
CREATE TRIGGER document_upload_notification_trigger
    AFTER INSERT ON public.documents
    FOR EACH ROW EXECUTE FUNCTION public.handle_document_upload();

DROP TRIGGER IF EXISTS document_verification_notification_trigger ON public.documents;
...
-- Insert additional FAQ responses for document-related questions
